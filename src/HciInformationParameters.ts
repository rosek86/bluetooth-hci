...
export class ReadLocalSupportedFeatures {
  static outParams(params?: Buffer): LocalSupportedFeatures {
    ...
    return {
      threeSlotPackets:                     bigintBitGet(features, 0n),
      fiveSlotPackets:                      bigintBitGet(features, 1n),
      encryption:                           bigintBitGet(features, 2n),
      slotOffset:                           bigintBitGet(features, 3n),
      timingAccuracy:                       bigintBitGet(features, 4n),
      roleSwitch:                           bigintBitGet(features, 5n),
      holdMode:                             bigintBitGet(features, 6n),
      sniffMode:                            bigintBitGet(features, 7n),
      powerControlRequests:                 bigintBitGet(features, 9n),
      channelQualityDrivenDataRate:         bigintBitGet(features, 10n),
      scolink:                              bigintBitGet(features, 11n),
      hv2packets:                           bigintBitGet(features, 12n),
      hv3packets:                           bigintBitGet(features, 13n),
      microLawLogSynchronousData:           bigintBitGet(features, 14n),
      aLawLogSynchronousData:               bigintBitGet(features, 15n),
      cvsSynchronousData:                   bigintBitGet(features, 16n),
      pagingParameterNegotiation:           bigintBitGet(features, 17n),
      powerControl:                         bigintBitGet(features, 18n),
      transparentSynchronousData:           bigintBitGet(features, 19n),
      flowControlLagLsb:                    bigintBitGet(features, 20n),
      flowControlLagMiddleBit:              bigintBitGet(features, 21n),
      flowControlLagMsb:                    bigintBitGet(features, 22n),
      broadcastEncryption:                  bigintBitGet(features, 23n),
      enhancedDataRateAcl2MbpsMode:         bigintBitGet(features, 25n),
      enhancedDataRateAcl3MbpsMode:         bigintBitGet(features, 26n),
      enhancedInquiryScan:                  bigintBitGet(features, 27n),
      interlacedInquiryScan:                bigintBitGet(features, 28n),
      interlacedPageScan:                   bigintBitGet(features, 29n),
      rssiWithInquiryResults:               bigintBitGet(features, 30n),
      extendedScoLinkEv3Packets:            bigintBitGet(features, 31n),
      ev4Packets:                           bigintBitGet(features, 32n),
      ev5Packets:                           bigintBitGet(features, 33n),
      afhCapableSlave:                      bigintBitGet(features, 35n),
      afhClassificationSlave:               bigintBitGet(features, 36n),
      brEdrNotSupported:                    bigintBitGet(features, 37n),
      leSupported:                          bigintBitGet(features, 38n),
      threeSlotEnhancedDataRateAclPackets:  bigintBitGet(features, 39n),
      fiveSlotEnhancedDataRateAclPackets:   bigintBitGet(features, 40n),
      sniffSubrating:                       bigintBitGet(features, 41n),
      pauseEncryption:                      bigintBitGet(features, 42n),
      afhCapableMaster:                     bigintBitGet(features, 43n),
      afhClassificationMaster:              bigintBitGet(features, 44n),
      enhancedDataRateESco2MbpsMode:        bigintBitGet(features, 45n),
      enhancedDataRateESco3MbpsMode:        bigintBitGet(features, 46n),
      threeSlotEnhancedDataRateEScoPackets: bigintBitGet(features, 47n),
      extendedInquiryResponse:              bigintBitGet(features, 48n),
      simultaneousLeAndBrEdr:               bigintBitGet(features, 49n),
      secureSimplePairing:                  bigintBitGet(features, 51n),
      encapsulatedPdu:                      bigintBitGet(features, 52n),
      erroneousDataReporting:               bigintBitGet(features, 53n),
      nonFlushablePacketBoundaryFlag:       bigintBitGet(features, 54n),
      linkSupervisionTimeoutChangedEvent:   bigintBitGet(features, 56n),
      variableInquiryTxPowerLevel:          bigintBitGet(features, 57n),
      enhancedPowerControl:                 bigintBitGet(features, 58n),
      extendedFeatures:                     bigintBitGet(features, 63n),
    };
  }
}
