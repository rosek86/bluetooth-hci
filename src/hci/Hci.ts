...
import {
  ...
  type LeAdvertisingSetTerminatedEvent,
  LeChannelSelAlgo,
  ...
  LeDataLengthChange,
  type LeDataLengthChangeEvent,
  LeDirectedAdvertisingReport,
  type LeDirectedAdvertisingReportEvent,
  ...
  type LeReadLocalP256PublicKeyCompleteEvent,
  LeReadRemoteFeaturesComplete,
  type LeReadRemoteFeaturesCompleteEvent,
  LeRemoteConnectionParameterRequest,
  type LeRemoteConnectionParameterRequestEvent,
  type NumberOfCompletedPacketsEntry,
  type ReadRemoteSupportedFeaturesCompleteEvent,
