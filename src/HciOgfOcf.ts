...
export enum HciOcfLeControllerCommands {
  ...
  SetExtendedAdvertisingEnable                        = 0x0039, // i LE Set Extended Advertising Enable
  ReadMaximumAdvertisingDataLength                    = 0x003A, // i LE Read Maximum Advertising Data Length
  ReadNumberOfSupportedAdvertisingSets                = 0x003B, // * LE Read Number of Supported Advertising Sets
  RemoveAdvertisingSet                                = 0x003C, // i LE Remove Advertising Set
  ClearAdvertisingSets                                = 0x003D, // i LE Clear Advertising Sets
